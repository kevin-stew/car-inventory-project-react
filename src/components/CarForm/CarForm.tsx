...
import { chooseName, chooseDescription, choosePrice, chooseSafetyQuality, 
         chooseDriveTime, chooseMaxSpeed, chooseDimensions, chooseWeight, 
         chooseCostOfProduction, chooseMake } from '../../redux/slices/rootSlice';
    ...
    return (
        <div>
            <form onSubmit = {handleSubmit(onSubmit)}>
                ...
                <div>
                    <label htmlFor="safety_quality">Safety Quality</label>
                    <Input {...register('safety_quality')} name="safety_quality" placeholder="Safety Quality"/>
                </div>
                <div>
                    <label htmlFor="drive_time">Drive Time</label>
                    <Input {...register('drive_time')} name="drive_time" placeholder="Drive Time"/>
                </div>
                <div>
